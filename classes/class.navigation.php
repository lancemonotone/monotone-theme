...
class Navigation {
    ...
    public function register_menus() {
        register_nav_menus( [
            ...
            'helplineprimary' => __( 'Helpline Menu', 'monotone' ),
            'helplinefooter'  => __( 'Helpline Footer Menu', 'monotone' ),
            'helplinefootersupport'  => __( 'Helpline Footer Menu Support', 'monotone' ),
        ] );
    }
